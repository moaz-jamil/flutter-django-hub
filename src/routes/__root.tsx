...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Jamil Ahmed — Flutter & Django Developer" },
      {
        name: "description",
        content: "Flutter and Django developer building production mobile apps and REST APIs.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Jamil Ahmed" },
